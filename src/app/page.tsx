            ...
            <ScrollReveal delay={0.3}>
              <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 rounded-lg border border-border bg-surface-raised/50 px-5 py-2.5 text-sm font-medium text-heading backdrop-blur-xl transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-accent-dim hover:text-accent hover:bg-surface-overlay active:scale-[0.97]"
                >
